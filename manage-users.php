                                    ...
                                    <div class="p-4">
                                        <form>
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <label for="customerCode" class="form-label">Department Code</label>
                                                ...
                                                <div class="col-md-3">
                                                    <label for="customerCode" class="form-label">Department Name</label>
                                                    <div class="input-group mb-3">
                                                        <input id="customerCode" name="customerCode" type="text"
                                                            class="form-control">
                                                ...
                                                <div class="col-md-3">
                                                    <label for="customerCode" class="form-label">Sub Department</label>
                                                    <div class="input-group mb-3">
                                                        <input id="customerCode" name="customerCode" type="text"
                                                            class="form-control">
