                                    ...
                                    <div class="p-4">
                                        <form>
                                            <div class="row">
                                                ...
                                                <!-- Brand Category -->
                                                <div class="col-md-4 ">
                                                    <label for="brandCategory" class="form-label">Brand Category <span
                                                            class="text-danger">*</span></label>
                                                    <select id="brandCategory" name="brandCategory" class="form-select"
                                                ...
                                                <!-- Direct Discount -->
                                                <div class="col-md-3">
                                                    <label for="directDiscount" class="form-label">Direct Discount
                                                        %</label>
                                                    <div class="input-group mb-3">
                                                        <input id="directDiscount" name="directDiscount" type="text"
                                                            class="form-control"
