                            ...
                            <div class="card bg-primary">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-sm-8">
                                            <p class="text-white font-size-18">Access and manage your <b>Invoice</b>
                                                records efficiently <i class="mdi mdi-arrow-right"></i></p>
                                            <div class="mt-4">
                                                <a href="javascript: void(0);"
                                                    class="btn btn-success waves-effect waves-light"> Click to Sales
                                                    Invoice.</a>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
