...
if (isset($_POST['action']) && $_POST['action'] == 'create_quotation') {
    ...
    $customerId = $_POST['customer_code'];
    ...
    $QUOTATION_->sale_type = $salesType;
    ...
    if ($invoiceResult) {
        ...
        foreach ($items as $item) {
            ...
            $QUOTATION_ITEM->quotation_id = $quotationId;
            ...
            $QUOTATION_ITEM->sub_total = ($item['price'] * $item['qty']) - $QUOTATION_ITEM->discount;
