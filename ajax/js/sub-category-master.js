jQuery(document).ready(function () {
  ...
  $("#create").click(function (event) {
    ...
    if (!$("#code").val() || $("#code").val().length === 0) {
      ...
      $.ajax({
        url: "ajax/php/sub-category-master.php", // Adjust the URL based on your needs
        type: "POST",
        data: formData,
        async: false,
        cache: false,
  ...
  $("#update").click(function (event) {
    ...
    if (!$("#code").val() || $("#code").val().length === 0) {
      ...
      $.ajax({
        url: "ajax/php/sub-category-master.php",
        type: "POST",
        data: formData,
        async: false,
        cache: false,
  ...
  $(document).on("click", ".delete-sub-category", function (e) {
    ...
    if (!name || name === "") {
      swal({
        title: "Error!",
        text: "Please select a Ref No first.",
        type: "error",
        timer: 2000,
        showConfirmButton: false,
      });
    ...
    swal(
      {
        title: "Are you sure?",
        text: "Do you want to delete '" + name + "' Category Type?",
        type: "warning",
  ...
  $(document).on("click", ".select-ref", function () {
